                    ...
                    for (int sectionnum1 = 1; sectionnum1 <= tr.Count; sectionnum1++)
                    {
                        ...
                        for (int sectionnum2 = 1; sectionnum2 < 9; sectionnum2++)
                        {
                            ...
                            else if (EndList_x != "선택하신 도착지의 항로가 없습니다.")
                            {
                                ...
                                var C_Code = _driver.FindElement(By.XPath($"//*[@id='pnl_Default']/table[2]/tbody/tr[1]/td[{Num}]/a")).Text;
                                var D_Code = _driver.FindElement(By.XPath($"//*[@id='pnl_Text']/div[2]/table/tbody/tr[{sectionnum3}]/td[{sectionnum4}]")).Text;
