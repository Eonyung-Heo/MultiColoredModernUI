            ...
            try
            {
                ...
                for (var ListCountElementsCount = 1; ListCountElementsCount <= ListCountElements.Count; ListCountElementsCount++)
                {
                    ...
                    for (var RouteListCount = 1; RouteListCount <= RouteCount; RouteListCount++)
                    {
                        ...
                        {
                            string day = "";
                            //var operation = _driver.FindElement(By.CssSelector($"# outTbody > tr:nth-child(1) > td:nth-child({daycount}"));
                            var operation = _driver.FindElement(By.CssSelector($"<td data-title='월'></td>"));
