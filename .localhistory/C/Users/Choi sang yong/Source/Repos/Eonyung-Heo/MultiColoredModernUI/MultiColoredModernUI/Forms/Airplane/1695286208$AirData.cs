            ...
            try
            {
                ...
                for (var ListCountElementsCount = 1; ListCountElementsCount <= ListCountElements.Count; ListCountElementsCount++)
                {
                    ...
                    for (var RouteListCount = 1; RouteListCount <= RouteCount; RouteListCount++)
                    {
                        ...
                        {
                            string day = "";
                            var operation1 = _driver.FindElement(By.XPath($"//*[@id='outTbody']/tr[1]/td[{daycount}]/img")).GetAttribute("alt");
                            var operation2 = _driver.FindElement(By.XPath($"//*[@id='outTbody']/tr[1]/td[{daycount}]/img")).GetAttribute("alt");
                            /*
