...
namespace MultiColoredModernUI.Forms.Ship
{
    public partial class ShipLoad : Form
    {
        ...
        private void Ship_Fee_TB_TextChanged()
        {
            ...
            string Timerequired_TB = Ship_Timerequired_TB.Text;
            string Rank2_TB = Ship_Rank2_TB.Text;
            string Ship_AdultFee_TB = Ship_Ship_AdultFee_TB.Text;
            string Ship_YouthFee_TB = Ship_Ship_YouthFee_TB.Text;
            string Ship_SeniorFee_TB = Ship_Ship_SeniorFee_TB.Text;
            string Ship_ChildFee_TB = Ship_Ship_ChildFee_TB.Text;



            string strSql = "UPDATE NEW_SHIP.dbo.TBHarbor SET Addr = @TimeAdd where ODSayHarborID = @ODSayHarborID and ID = @ID";
