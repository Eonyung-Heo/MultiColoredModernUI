    ...
    public partial class AirData : Form
    {
        ...
        public void Airplane_DataCrawling()
        {
            try
            {
                ...
                // 크롤링
                for (var ListCountElementsCount = 3; ListCountElementsCount <= ListCountElements.Count; ListCountElementsCount++)
                {
                    // 공항 선택
                    ...
                    for (var RouteListCount = 1; RouteListCount <= RouteCount; RouteListCount++)
                    {
                        ...
                        else
                        {
                            ...
                            var testdata2 = _driver.FindElement(By.XPath($"//*[@id='outTbody']/tr[{RouteListCount}]/td[11]")).Text.Substring(23,46);
                            var testdata3 = _driver.FindElement(By.XPath($"//*[@id='outTbody']/tr[{RouteListCount}]/td[11]")).Text.Substring(46);
