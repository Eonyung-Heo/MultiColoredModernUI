            ...
            try
            {
                ...
                for (var ListCountElementsCount = 1; ListCountElementsCount <= ListCountElements.Count; ListCountElementsCount++)
                {
                    ...
                    for (var RouteListCount = 1; RouteListCount <= RouteCount; RouteListCount++)
                    {
                        ...
                        {
                            string day = "";
                            IWebElement element = _driver.FindElement(By.XPath("//*[@id='outTbody']/tr[1]/td[4]"));
                            ...
                            {
                                // <img> 태그가 존재하는 경우
                                Console.WriteLine("해당 요소에 <img> 태그가 존재합니다.");
                            }
                            else
                            {
                                // <img> 태그가 존재하지 않는 경우
                                Console.WriteLine("해당 요소에 <img> 태그가 존재하지 않습니다.");
                            }

                            /*
                            if ()
                            {
                                var operation1 = _driver.FindElement(By.XPath($"//*[@id='outTbody']/tr[1]/td[{daycount}]")).Text;
                            }
                            else
                            {
                                var operation2 = _driver.FindElement(By.XPath($"//*[@id='outTbody']/tr[1]/td[{daycount}]/img")).Text;
                            }*/
                            /*
                            IWebElement operation1 = _driver.FindElement(By.CssSelector($"#outTbody > tr:nth-child(1) > td:nth-child({daycount})"));
                            var operation2 = operation1.FindElements(By.TagName("img"))
                            string operation3 = operation1.GetAttribute("alt");*/
                            if (1 == 1)
                            {
                                if (daycount == 4)
                                {
