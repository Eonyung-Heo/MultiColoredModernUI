            ...
            try
            {
                ...
                for (var ListCountElementsCount = 1; ListCountElementsCount <= ListCountElements.Count; ListCountElementsCount++)
                {
                    ...
                    for (var RouteListCount = 1; RouteListCount <= RouteCount; RouteListCount++)
                    {
                        ...
                        {
                            string day = "";
                            var operation1 = _driver.FindElement(By.XPath($"/html/body/div[6]/div[2]/article/div[1]/div[3]/table/tbody/tr[1]/td[{daycount}]"));
                            var operation2 = operation1.FindElement(By.TagName("img"));
                            var operation3 = operation2.ToString();
                            //var daylist = operation2.Text;

                            ///html/body/div[6]/div[2]/article/div[1]/div[3]/table/tbody/tr[1]/td[10]
                            ///html/body/div[6]/div[2]/article/div[1]/div[3]/table/tbody/tr[1]/td[9]/img
