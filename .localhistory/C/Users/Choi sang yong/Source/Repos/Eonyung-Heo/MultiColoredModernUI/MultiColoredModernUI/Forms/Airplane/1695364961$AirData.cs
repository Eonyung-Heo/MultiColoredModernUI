                ...
                for (var ListCountElementsCount = 3; ListCountElementsCount <= ListCountElements.Count; ListCountElementsCount++)
                {
                    ...
                    for (var RouteListCount = 1; RouteListCount <= RouteCount; RouteListCount++)
                    {
                        ...
                        else
                        {
                            ...
                            var testdata2 = _driver.FindElement(By.XPath($"//*[@id='outTbody']/tr[{RouteListCount}]/td[11]")).Text.Substring(23,45);
                            var testdata3 = _driver.FindElement(By.XPath($"//*[@id='outTbody']/tr[{RouteListCount}]/td[11]")).Text.Substring(45);
