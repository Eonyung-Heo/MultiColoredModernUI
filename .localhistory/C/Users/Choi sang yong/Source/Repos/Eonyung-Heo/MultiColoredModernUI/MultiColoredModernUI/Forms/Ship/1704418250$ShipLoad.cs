...
namespace MultiColoredModernUI.Forms.Ship
{
    public partial class ShipLoad : Form
    {
        ...
        private void Ship_Fee_TB_TextChanged()
        {
            ...
            string strSql = "UPDATE NEW_SHIP.dbo.TBShipLaneInfo SET StartTime = @TimeAdd, Rank = @Rank2Add, TimeRequired = @TimerequiredAdd, AdultFee = @AdultFeeAdd, YouthFee = @YouthFeeAdd, SeniorFee = @SeniorFeeAdd, ChildFee = @ChildFeeAdd where ODSayLaneID = @ODSayLaneID and StartTime = @TimeAdd";
